# Deep Phenotype / Process Report Contract
...
- Include the exact target phenotype/process feature and request URLs.
...
- Phenotype/process reports deduplicate events by gene + alteration taxonomy + hypothesis because the phenotype/process feature is fixed by the query.
...
- Caveat broad phenotype/process features as evidence maps, not narrow causal mechanisms.
